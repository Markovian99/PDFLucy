...
from app_utils import generate_responses, initialize_session_state
...
with st.sidebar:
    ...
    st.session_state["general_context"] = st.text_area(f"Enter extra prompt details (added to the beginning of all prompts)", "You are a financial analyst with a strong business intuition.")+" "
...
if app_task == "Report Generator" and st.session_state['uploaded_file']:
    ...
    st.write("Report Generator Not Found")
